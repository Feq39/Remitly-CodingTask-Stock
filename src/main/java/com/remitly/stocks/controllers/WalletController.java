...
public class WalletController {
    ...
    public WalletDTO getWalletState(@PathVariable(name = "wallet_id") @Size(min = 1, max = 100) String publicWalletId) {
    ...
    public long getQuantityOfStockInWallet(@PathVariable(name = "wallet_id") @Size(min = 1, max = 100) String publicWalletId, @PathVariable(name = "stock_name") @Size(min = 1, max = 100) String stockName) {
    ...
    public void processTransaction(@PathVariable(name = "wallet_id") @Size(min = 1, max = 100) String publicWalletId, @PathVariable(name = "stock_name") @Size(min = 1, max = 100) String stockName, @RequestBody OperationTypeDTO operationTypeDTO) {
